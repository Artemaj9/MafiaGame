...
struct DescriptionDetailCell: View {
    let title: String = "ROLE"
    let information: String = "Citizens are ordinary townspeople. Their goal is to survive and identify the Mafia for lynching during the day."
